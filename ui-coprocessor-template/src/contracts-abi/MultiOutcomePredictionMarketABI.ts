...
export const MultiOutcomePredictionMarket = [
  ...
  },
  {
    ...
    "inputs": [
      ...
      { "name": "_initialShares", "type": "uint256[]", "internalType": "uint256[]" },
      { "name": "_liquidity", "type": "uint256", "internalType": "uint256" },
      { "name": "_outcomes", "type": "string[]", "internalType": "string[]" }
    ],
    "outputs": [],
    "stateMutability": "nonpayable"
  },
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct MultiOutcomePredictionMarket.Market",
        "components": [
          { "name": "question", "type": "string", "internalType": "string" },
          { "name": "circulatingShares", "type": "uint256[]", "internalType": "uint256[]" },
  ...
  },
  {
    ...
    "inputs": [
      ...
      { "name": "nShares", "type": "uint256", "internalType": "uint256" }
    ],
    "outputs": [],
    "stateMutability": "nonpayable"
  },
  ...
  },
  {
    ...
    "outputs": [
      { "name": "ownedShares", "type": "uint256", "internalType": "uint256" }
    ],
    "stateMutability": "view"
  },
  {
  ...
  },
  {
    ...
    "name": "ResultReceived",
    "inputs": [
      { "name": "inputPayloadHash", "type": "bytes32", "indexed": true, "internalType": "bytes32" },
      { "name": "output", "type": "bytes", "indexed": false, "internalType": "bytes" }
    ],
    "anonymous": false
  },
  {
